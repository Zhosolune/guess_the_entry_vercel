...
export const TopBar: React.FC<TopBarProps> = memo(({ progress, onOpenGameInfo, gameInfoOpen, onOpenScoreboard, scoreboardOpen, onOpenSettings, settingsOpen }) => {
  ...
  /**
   * 处理设置按钮点击
   * 当提供 onOpenSettings 回调时触发；否则不进行任何操作
   *
   * @returns void
   */
